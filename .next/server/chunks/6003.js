...
/* harmony export */   "i": () => (/* binding */ ImportQuestionModal)
/* harmony export */ });
...
const ImportQuestionModal = (props)=>{
    ...
    const saveMutation = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useMutation)((data)=>(0,apis_question__WEBPACK_IMPORTED_MODULE_7__/* .uploadQuestions */ .ts)(data));
    ...
    const onFinish = (data)=>{
        ...
        saveMutation.mutate(bodyData, {
            onSuccess: ()=>{
                ...
                antd__WEBPACK_IMPORTED_MODULE_1__.message.success("Question added successfully");
                setToBeUploadedDocs([]);
            },
            onError: (data)=>{
