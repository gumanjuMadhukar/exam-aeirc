...
const attendanceListColumns: ColumnsType<AttendanceDataType> = [
  ...
  },
  {
    ...
    dataIndex: 'check_in',
    key: 'check_in',
    render: text => <a>{TimeFormatHMM(text)}</a>
  },
  {
    title: 'Check Out',
    dataIndex: 'check_out',
  ...
  },
  {
    ...
    key: 'worked_seconds',
    render: text => <a>{SecondIntoHours(text)} hrs</a>
  }
];
...
const shift = (value: any) => {
  switch (value) {
    ...
    case 'HALF_SECOND':
      return <Image src={'second_half.svg'} />;
    case 'HALF_FIRST':
      return <Image src={'first_half.svg'} />;
    case 'FULL':
      return <CheckCircleFilled style={{ color: ' #389E0D' }} />;
  }
};
...
const Attendance = () => {
  ...
  const [dateRange, setDateRange] = useState<boolean>(true);
  ...
  return (
    <>
      <PayrollSummaryContainer>
          ...
          <SearchBar>
            <Form>
              <SearchBarContentRedisgn>
                ...
                <Button style={{ boxShadow: 'none' }} onClick={handleSearch}>
                  Search
                </Button>
              </SearchBarContentRedisgn>
            </Form>
        ...
        <TableBodyContainer>
          <Row>
            <Col span={!!openAttendanceDetails ? 19 : 24}>
              <Table
